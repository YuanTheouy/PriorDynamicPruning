...
export WIKITEXT_LABEL_FILE="${WIKITEXT_LABEL_DIR}/${WIKITEXT_RUN_ID}_delta_nll_greedy_set_labels.jsonl"
export WIKITEXT_CANDIDATE_LABEL_FILE="${WIKITEXT_RELATED_LABEL_DIR}/${WIKITEXT_RUN_ID}_c16_candidate_delta_nll.jsonl"
